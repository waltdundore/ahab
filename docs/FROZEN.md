# FROZEN — former README.md (marketing-era entrypoint)

Moved here verbatim on 2026-09-11 when `README.md` was rewritten to a factual entrance; content preserved, not deleted. Claims below were NOT re-verified and may be false — see BLUEPRINT.md cold-audit rows and `README.md` §"State of this repo". Nothing below was re-verified; several items (external repos, web pages, credibility and "tests-passing" claims) cannot be settled from files in this repo at all.
