...
| **ansible-inventory** | Environment definitions | git@github.com:waltdundore/ansible-inventory.git |
| **ahab-modules** | Service definitions | git@github.com:waltdundore/ahab-modules.git |
...
We follow NASA Power of 10 rules. Schools can't afford data loss.
...
- **Verified**: All 10 rules accurately implemented for shell scripts
- **Adapted**: C-specific rules (pointers, memory) translated to shell equivalents
- **Why It Matters**: Schools can't afford data loss - safety-critical standards prevent bugs
- **Tool**: `make test-nasa` validates compliance
